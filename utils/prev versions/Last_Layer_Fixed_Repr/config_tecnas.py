...
REPRESENTATION_TYPE = 'L'  #L: layer, B: block
ENCODING_TYPE = 'BIN' #INT: integer vector, BIN: binary vector
...
HHSE_MARKOV_TYPES =  ['CROSS', 'MUT', 'HV', 'DHV', 'COMBINED'] 
perc_intervals = [20, 40, 20, 20] #MUT HV DHV CROSS for COMBINED MARKOV

HHSE_GREEDY_CRITERIA = 'HV' #'HV', 'DHV', 'MUT', 'CROSS' TO CREATE MARKOV MODELS
PLOT_PARETO = False
