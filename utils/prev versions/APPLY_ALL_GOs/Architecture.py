...
class Architecture(ABC):
    ...
    def set_report_path(self, tecnasObj = None):
        ...
        architecture_csv_filename_extended = f'{folder_name}_E{ConfigClass.EXECUTIONS}_G{ConfigClass.GENERATIONS}_N{ConfigClass.MAIN_NPOP}_{ConfigClass.SORT_ARCHS}_{"HHSE" if tecnasObj.HHSE else ""}_{"NSGA2" if config_tecnas.NSGA2 else ""}.csv'
