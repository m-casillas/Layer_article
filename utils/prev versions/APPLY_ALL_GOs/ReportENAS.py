...
class ReportENAS:
    ...
    def save_generation_status(self, statusObj):
        ...
        path_report = os.path.join(statusObj.path_report, 'generation_status.csv')
    ...
    def save_arch_info(self, tecnasObj, arch = None, epochs = ConfigClass.EPOCHS):
        ...
        dict_archinfo = {'ID': tecnasObj.representation_type + str(arch.idx), 
             ...
             'HHSE': tecnasObj.HHSE,  #label = 'high' if x > 10 else 'medium' if x > 5 else 'low'
             'HHSE_TYPE': 'TREE' if config_tecnas.HHSE_Tree else 'RANDOM' if config_tecnas.HHSE_RANDOM else 'GREEDY' if config_tecnas.HHSE_GREEDY else '',
