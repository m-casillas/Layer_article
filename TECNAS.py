...
class TECNAS:
    ...
    def plot_bars_matplotlib(self, reportCSV_list, column_list):
        ...
        path_fig = os.path.join(path_figures, f'{self.filename}_bars_{last_name}.png')
    ...
    def plot_grouped_boxplots(self, reportCSV_list, column_list):
        ...
        last_name = create_last_name(column_list)
        path_fig = os.path.join(path_figures, f'{self.filename}_boxes_{last_name}.png')
        plt.savefig(path_fig)
        plt.show()
        print(f'Figure saved in {path_fig}')
        plt.clf()
    ...
    def plot_accuracy_loss_histories(self, plot_type):
        ...
        plt.legend()
        plt.grid(True)
        path_fig = os.path.join(path_figures, f'{self.filename}_{ylabel}_exec.png')
        plt.savefig(path_fig)
        plt.show()
        print(f'Figure saved in {path_fig}')
        plt.clf()
    ...
    def plot_accuracy_loss_fromFiles(self, reportFileNamesLst, plot_type):
        ...
        plt.legend()
        path_fig = os.path.join(path_figures, f'{self.filename}_{value_name}_medians.png')
        plt.savefig(path_fig)
        plt.show()
        print(f'Figure saved in {path_fig}')
        plt.clf()
