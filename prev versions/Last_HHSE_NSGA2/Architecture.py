...
class Architecture(ABC):
    ...
    def set_report_path(self, tecnasObj = None):
        ...
        architecture_csv_filename_extended = f'{folder_name}_E{ConfigClass.EXECUTIONS}_G{ConfigClass.GENERATIONS}_N{ConfigClass.MAIN_NPOP}_{ConfigClass.SORT_ARCHS}_{"HHSE" if tecnasObj.HHSE else ""}_{config_tecnas.NSGA_II_SELECTION_CSVREPORT[config_tecnas.NSGA_II_SELECTION[0]] if tecnasObj.HHSE else ""}.csv'
    ...
    def __init__(self, encoding = 'IV', idx = '9999', genotypeObj = None):
        ...
        self.NFHT = -1 #Normalized First Hitting Time
