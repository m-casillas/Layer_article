...
def split_all_csvs_in_folder(input_folder, path_results):
    ...
    for input_file in os.listdir(input_folder):
        ...
        if input_file.endswith('.csv'):
            ...
            if is_HHSE(input_file):
                print('HHSE detected. Copying same file to splitted folder')
                shutil.copyfile(os.path.join(input_folder, input_file), os.path.join(path_results, input_file))
