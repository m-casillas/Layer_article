...
#mutation_types_list = ['L_MODIFY_PARAMS']
...
if search_strategies_list == ['RANDOM']:
    TOTAL_ARCH = MAIN_NPOP*GENERATIONS*EXECUTIONS
else:
    TOTAL_ARCH = 3*MAIN_NPOP*GENERATIONS*EXECUTIONS*len(mutation_types_list)*len(crossover_types_list) + MAIN_NPOP*GENERATIONS*EXECUTIONS
